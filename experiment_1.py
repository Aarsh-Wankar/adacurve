...
adacurve_filename = "./results_adacurve.csv"
adahessian_filename = "./results_adahessian.csv"


with open(adacurve_filename, "w", newline="") as adacurve_f, open(adahessian_filename, "w", newline="") as adahessian_f:
